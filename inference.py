...
def detect(im, model, transform):
    ...
    return  predictions[keep] , keypoints_scaled
...
im = Image.open("/home/pranoy/Downloads/man.jpg")
...
def plot_results(pil_img, scores, keypoints):
    ...
    for s,(xmin, ymin, xmax, ymax), c in zip(scores, keypoints.tolist(), COLORS * 100):
